...
import PropsSanPham from "./PropsSanPham";
...
export default class DemoPropsFunction extends Component {
    ...
    return this.arrProduct.map((product, index) => {
      return (
        <div key={index} className="col-4">
          <PropsSanPham xemCT={this.xemChiTiet} product={product} />
        </div>
      );
    });
  };
  ...
  xemChiTiet = (spClick) => {
    //setState của sp chi tiết => render lại
    this.setState({
    ...
    return (
      <div className="container">
        ...
        <div className="row mt-5">
          <div className="col-4">
            <h3 className="text-center">I Phone</h3>
            <img
